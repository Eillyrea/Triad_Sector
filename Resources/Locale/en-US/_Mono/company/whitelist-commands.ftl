...
cmd-company-company-does-not-exist = Faction {$company} does not exist.
cmd-company-player-not-found = Player {$player} not found.
cmd-company-hint-player = [player]
cmd-company-hint-company = [company]

command-description-company-addmember = Lets a player play a whitelisted player faction.
...
command-description-company-playercompanies = Gets all the factions that a player has been whitelisted for.
cmd-company-playercompanies-whitelisted-for = Player {$player} is whitelisted for:
{$companies}

command-description-company-members = Gets all the players that has been whitelisted for a player faction.
cmd-company-members-whitelisted-for = Faction {$company} is whitelisted for:
    {$players}
    {$company} owners:
    {$owners}

command-description-company-setowner = Set owner status of a player in company. Note: Add member to player faction before this command!
cmd-company-setowner-success = Successfully changed owner status of {$player} to {$status}

command-description-company-removemember = Removes a player's ability to play a whitelisted player faction.
